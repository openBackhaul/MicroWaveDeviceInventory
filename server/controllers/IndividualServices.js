...
//to add
module.exports.getCachedWredTemplateProfileCapability = function getCachedWredTemplateProfileCapability(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.getCachedWredTemplateProfileCapability(user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.getCachedWredTemplateProfileConfiguration = function getCachedWredTemplateProfileConfiguration(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.getCachedWredTemplateProfileConfiguration(user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.getLiveWredTemplateProfileCapability = function getLiveWredTemplateProfileCapability(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.getLiveWredTemplateProfileCapability(user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.getLiveWredTemplateProfileConfiguration = function getLiveWredTemplateProfileConfiguration(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.getLiveWredTemplateProfileConfiguration(user, originator, xCorrelator, traceIndicator, customerJourney, mountName, uuid, fields)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
module.exports.provideCacheQualityStatistics = function provideCacheQualityStatistics(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideCacheQualityStatistics(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.provideDataOfLinkPorts = function provideDataOfLinkPorts(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideDataOfLinkPorts(user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.provideDataOfLinks = function provideDataOfLinks(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideDataOfLinks(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
module.exports.provideDeviceStatusMetadata = function provideDeviceStatusMetadata(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  ...
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideDeviceStatusMetadata(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
module.exports.provideListOfCachedDevices = function provideListOfCachedDevices(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideListOfCachedDevices(req.url, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.provideListOfLinkPorts = function provideListOfLinkPorts(req, res, next, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideListOfLinkPorts(user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
...
//to add
module.exports.provideListOfLinks = function provideListOfLinks(req, res, next, body, user, originator, xCorrelator, traceIndicator, customerJourney) {
  let startTime = process.hrtime();
  let responseCode = responseCodeEnum.code.OK;
  let responseBodyToDocument = {};
  IndividualServices.provideListOfLinks(body, user, originator, xCorrelator, traceIndicator, customerJourney)
    .then(async function (responseBody) {
      responseBodyToDocument = responseBody;
      let responseHeader = await restResponseHeader.createResponseHeader(xCorrelator, startTime, req.openapi.openApiRoute);
      restResponseBuilder.buildResponse(res, responseCode, responseBody, responseHeader);
